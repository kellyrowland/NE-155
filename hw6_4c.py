...
n_iter = SOR(A,S_matrix,phi_old,omega,eps)[0]
...
e3b = np.array([23,86,1977,7820])
e5b = np.array([24,70,2862,11324])
e3c = np.array([14,33,1132,4550])
e5c = np.array([24,70,2017,8054])
...
plt.title("Number of Iterations vs. Mesh Size for SOR Method")
plt.savefig('hw6_4c.pdf')
